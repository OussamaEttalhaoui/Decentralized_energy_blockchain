...
// const BuyerPage = ({ web3, account, contract }) => {
//   return (
//     <div className="min-h-screen bg-gray-50 p-6">
//       <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
//         <h2 className="text-3xl font-semibold text-center text-green-600 mb-8">Bienvenue sur la Page de l'Acheteur</h2>
//         <EnergyMarket web3={web3} account={account} contract={contract} role="Acheteur" />
//       </div>
//     </div>
//   );
// };
